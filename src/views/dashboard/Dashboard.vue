      ...
      return {
        dailySalesChart: {
          ...
          options: {
            ...
            low: 0,
            high: 50, // Kothing: we recommend you to set the high sa the biggest value + something for a better look
            chartPadding: {
              top: 0,
              right: 0,
              bottom: 0,
        ...
        dataCompletedTasksChart: {
          ...
          options: {
            ...
            low: 0,
            high: 1000, // Kothing: we recommend you to set the high sa the biggest value + something for a better look
            chartPadding: {
              top: 0,
              right: 0,
              bottom: 0,

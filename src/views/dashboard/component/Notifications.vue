          ...
          <v-row>
            ...
            >
              <div>
                ...
                <div class="grey--text">
                  The first step is to create an account at Kothing. You can choose a social network or go for the classic version, whatever works best for you.
                </div>
              </div>
            </v-col>
            ...
            >
              <div>
                ...
                <div class="grey--text">
                  The first step is to create an account at <a href="https://github.com/kothing/">Kothing</a>. You can choose a social network or go for the classic version, whatever works best for you.
                </div>
              </div>
            </v-col>
            ...
            <v-col cols="12">
              If you have more questions, don't hesitate to contact us or send us a tweet @kothing. We're here to help!
            </v-col>
          </v-row>
